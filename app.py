...
# ==================== GESTOR DE MATERIALES EN SIDEBAR ====================
with st.sidebar.expander("➕ Agregar Nuevo Material"):
    nuevo_nombre = st.text_input("Nombre completo del material")
    nuevo_precio = st.number_input("Precio por kg ($)", min_value=0.0, value=399.0, step=10.0)
...
# ... (el resto del código se mantiene igual, incluyendo la parte de materiales, tiempo y cálculo)
